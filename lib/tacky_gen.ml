...
(* convenience function: append instruction to the end of a list *)
let ( @::: ) is i = is @ [ i ]

(* convert op ast -> tacky *)
...
let convert_binop = function
    | Ast.Add -> Tacky.Add
    | Ast.Subtract -> Tacky.Substract
    | Ast.Multiply -> Tacky.Multiply
    | Ast.Divide -> Tacky.Divide
    | Ast.Mod -> Tacky.Mod

(* return list of instructions to elevate expression a and resulting TACKY value as a pair *)
...
(* helper function for individual expression *)
